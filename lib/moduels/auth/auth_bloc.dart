...
class AuthBloc extends Bloc<AuthEvent, AuthState>{
  ...
  AuthBloc() : super(AuthState()){
    ...
    on<SendLinkResetPasswordEvent>((event, emit) => _sendLinkResetPassword(event, emit));
  ...
  void _signUpEvent(SignUpEvent event, Emitter<AuthState> emit) async {
    ...
    try {
      await authRepository.signUpWithEmailPassword(fullName: event.fullName, email: event.email, password: event.password, image: event.image);
  ...
  void _sendLinkResetPassword(SendLinkResetPasswordEvent event, Emitter<AuthState> emit) async {
