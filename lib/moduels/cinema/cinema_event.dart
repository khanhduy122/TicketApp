...
class GetAllMovieReleasedCinemaEvent extends CinemaEvent{
  ...
  GetAllMovieReleasedCinemaEvent({required this.cinema, required this.date, required this.context});
}
...
class GetCinemasShowingMovieEvent extends CinemaEvent{
  ...
  GetCinemasShowingMovieEvent({required this.cityName, required this.movieID, required this.date, required this.context});
}
