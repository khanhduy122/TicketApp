...
class PaymentScreen extends StatefulWidget {
  const PaymentScreen({super.key, required this.paymentCard, required this.ticket});
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    paymentBloc.add(CreatePaymentUrlEvent(paymentCard: widget.paymentCard, ticket: widget.ticket));
    super.initState();
  }
        ...
        if(state.error is SeatReservedException){
          DialogError.show(
            ...
            onTap: (){
              ...
              Navigator.popUntil(context, (route) => route.settings.name == RouteName.selectSeatScreen);
            }
          );
          return;
        }
