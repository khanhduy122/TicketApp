...
class DetailTicketExpiredScreen extends StatefulWidget {
  const DetailTicketExpiredScreen({super.key, required this.ticket,});

  final Ticket ticket;

  @override
  State<DetailTicketExpiredScreen> createState() => _DetailTicketExpiredScreenState();
}
          ...
          child: Column(
            children: [
              ...
              ButtonWidget(
                ...
                width: 250.w, 
                onPressed: (){
                  Navigator.pushNamed(context, RouteName.writeReviewScreen, arguments: widget.ticket);
                }
              )
            ],
          ),
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          ...
          _buildItemInformation(title: "Ngày giờ: ", value: widget.ticket.formatDateTime()),
          _buildItemInformation(title: "Ghế: ", value: widget.ticket.getSeatString()),
  ...
  Widget _buildItemInformation({required String title, required String value}){
    return Row(
      ...
      children: [
        ...
        Expanded(child: Text(value, style: AppStyle.defaultStyle.copyWith(color: AppColors.white), maxLines: 10, textAlign: TextAlign.end,)),
      ],
    );
  }
