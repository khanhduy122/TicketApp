...
class RatingWidget extends StatelessWidget {
  const RatingWidget({super.key, required this.rating, this.total, this.isCenter});
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        SizedBox(width: 10.w,),
        total != null ? Text("(${formatTotal(total!)})", style: AppStyle.defaultStyle.copyWith(fontSize: 12),) : Container()
      ],
    );
  }
